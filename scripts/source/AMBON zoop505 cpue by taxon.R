...
# captured in 505 micron net during AMBON cruises (species with adult
# stages > ~2mm)

# Author: Franz Mueter
# Last update: September 6, 2021

# CPUE (biomass) and haul info saved as 'zoop505.RData'
...
# Set all 'small' zooplankton taxa to 'other.unid'
taxa <- taxa %>% mutate(taxon = replace(taxon, small == 1, "other.unid")) 
